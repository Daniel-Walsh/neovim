  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        tailwindcss = require 'lspconfig.configs.tailwindcss',
        -- tailwindcss = {
        ...
        --     root_files = require('lspconfig.util').root_markers_with_field(root_files, { 'mix.lock' }, 'tailwind', fname)
    ...
    --     end
    --
    --     -- extend(opts.servers.ts_ls, "settings.ts_s
    --   end,
    -- },
  },
}
